...
public static partial class NoiseGen {
    ...
    public interface ILattice{
        public LatticeValuesVectorized GenerateLatticeValues(float4 coordinates, int frequency);
    }
    ...
    public struct OpenLattice : ILattice{
        public LatticeValuesVectorized GenerateLatticeValues(float4 coordinates, int frequency){ // frequency to be able to generate a tiling noise over the frequency
